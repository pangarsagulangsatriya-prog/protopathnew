import { ProtoPathDatabase } from './types';

export const INITIAL_DATABASE: ProtoPathDatabase = {
  datasets: [
    {
    ...
    {
      id: 'dataset-mapillary-points-kosambi',
      name: 'Mapillary Observations Kosambi Corridor',
      sourceFile: 'mapillary-points.sample.json',
      recordCount: 1240,
      valueTypeCount: 39,
    },
  ],
  ...
  dataProvocations: [
    {
      id: 'dp-c1-3-1',
      code: 'DP.C1.3.1',
      sourceFeatureIds: ['source-c1-3-no-right-turn'],
  ...
  situations: [
    {
      ...
      dataProvocationIds: ['dp-c1-3-1'],
      objectTokens: ['REGULATORY_OBJECT', 'LINEAR_OBJECT'],
      activeVectors: ['forward-drive', 'prohibition-pressure'],
      validationStatus: 'valid',
    },
    {
      id: 'situation-c1-3-2',
  ...
  bodyImpulses: [
    {
      ...
      respondsToSituationIds: ['situation-c1-3-1'],
      anatomicalLoci: ['spine', 'pelvis'],
      spatialOutputIds: ['output-locked-axis'],
      kineticQualities: ['arrested-forward-drive', 'held-tension', 'grip-maintained'],
      validationStatus: 'valid',
    },
    {
      ...
      respondsToSituationIds: ['situation-c1-3-2'],
      anatomicalLoci: ['wrist', 'shoulder'],
      spatialOutputIds: ['output-tremor-loop'],
      kineticQualities: ['mechanical-tremor', 'micro-displacement', 'uncorrected-drift', 'grip-maintained'],
      validationStatus: 'valid',
    },
  ],
  spatialOutputs: [
  ...
  sequenceFrames: [
    {
      ...
      activeEntityIds: ['source-c1-3-no-right-turn'],
      durationMs: 1000,
    },
    {
      ...
      activeEntityIds: ['dp-c1-3-1', 'situation-c1-3-1'],
      durationMs: 1200,
    },
    {
      id: 'frame-freeze',
      ...
      activeEntityIds: ['body-impulse-c1-3-1', 'output-locked-axis'],
      durationMs: 1400,
    },
    {
      ...
      activeEntityIds: ['situation-c1-3-2'],
      durationMs: 1200,
    },
    {
      ...
      activeEntityIds: ['body-impulse-c1-3-2', 'output-tremor-loop'],
      durationMs: 1600,
    },
  ],
  notationPairs: [
    {
      ...
      sourceFeatureIds: ['source-c1-3-no-right-turn'],
      dataProvocationIds: ['dp-c1-3-1'],
      situationIds: ['situation-c1-3-1'],
      bodyImpulseIds: ['body-impulse-c1-3-1'],
      spatialOutputIds: ['output-locked-axis'],
    ...
    },
    {
      ...
      sourceFeatureIds: ['source-c1-3-no-right-turn'],
      dataProvocationIds: ['dp-c1-3-1'],
      situationIds: ['situation-c1-3-2'],
      bodyImpulseIds: ['body-impulse-c1-3-2'],
      spatialOutputIds: ['output-tremor-loop'],
